...
class Client_:
    ...
    def UploadFile(self,file_path):
            ...
            if TupleFileInfo != 0:
                ...
                TupleFile_ = tuple((*TupleFileInfo,BytesFile_))

                ObjStruct = struct.pack('32sL32s%ss'%TupleFileInfo[1],*TupleFile_)
                self.sock.sendall(ObjStruct)
                ObjFile_.close()
...
filename = "l_python3_pu3_2018.3.039.tgz"
C=Client_()
